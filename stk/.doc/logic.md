...
——————————————————————————————————————————————————————————————————————————————
  ...
  创业板b现在价格是1.6左右，那它就是160万借了100万，<杠杆率>是62%。
...
1 凌厉跌破ma20，并跌停，留下10个点的<筹码真空区>，缩量整理10天
2 配合指数的1日穿2线F15(ma20.ma80)，最后15分钟涨停
3 个股合力：基本面(高业绩)、技术面(放量+DDE+有压力线)、消息面(收购公司)
4 12-25半个小时成交相当调整时一日成交，彻底消化套牢盘
5 放量大涨，并彻底打开了上升空间
6 进入主升连续涨停模式(3天放量+1天缩量涨停+放量+缩量)
7 上午11点前3浪上升+6%并日内最高点，即表明上升结束

# 案例52 K的中线逻辑

农村工作会议结束，内容有3点：
1 以农村土地征收、集体经营性建设用地入市、宅基地制度改革为代表的“三块地”改革试点将全面深入；
2 以土地确权登记颁证工作为代表的农村土地承包经营制度改革将迎来系列部署；
3 耕地保护和补偿制度将迎来顶层设计。
