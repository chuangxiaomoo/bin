...
# 资金管理 -- 反橄榄球模型
  ...
  2014-12-23 +2% 时出货不到 %5，从角度上来讲，应该是要在50%，特别是下午上证跳水的情况下。
  根据ma2.5

  root@Moo64:~/bin/stk# END=2014-12-22 NUM=2 SELECT pma 2241
  +--------+-----------+---------+-------+
  | code   | ma2       | @iclose | pcnt  |
  +--------+-----------+---------+-------+
  | 002241 | 25.144913 |   24.74 | -1.64 |
  +--------+-----------+---------+-------+

  root@Moo64:~/bin/stk# END=2014-12-23 NUM=2 SELECT pma 2241
  +--------+-----------+---------+-------+
  | code   | ma2       | @iclose | pcnt  |
  +--------+-----------+---------+-------+
  | 002241 | 24.875571 |   24.75 | -0.51 |
  +--------+-----------+---------+-------+
