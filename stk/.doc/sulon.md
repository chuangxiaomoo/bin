...
所谓简易，即为宇宙万物万千现象的简化描述，即<阴阳>，对于波动，简化后的波动就只是推动与非推动。推动若为阳，非推动即为阴。

所谓变易，指即为现象和过程，推动与非推动相互变化和转换，体现了事物<波浪式前进、螺旋式上升>的内在规律。这也就是我们所说的推动与非推动的交替原则，无论是在趋势行情的大推动结构中，或者是盘整型的大结构中，推动与非推动结构总是会交替出现。

所谓不易，波动大趋势上体现出的规律总有恒定轨迹可寻的。它是不变中的变化，就如市场<唯一永恒不变的事物就是变化。而这种变化本身又是有规律可寻的>，它所遵从的即是自然波动法则，而艾略特的波浪理论，本身就是这样的观察工具。所以，你根本没有必要去独创一个理论，你只需要在原有已经成形的理论基础上，改变一下思维方式。<巴菲特：投资就是投国运，300投资史，没有一个因国运发财的。国运如果没有了，你做空赚的那点钱都不够买一碗粥的。所有未来只有人类繁荣昌盛才有意义，即人类不能主宰自已的的沉浮，只可向上，不可堕落。所有都基于一个大假设--天行健，君子以自强不息。>亦是所谓“不二法门”，<没有地狱天堂安在>没有创板，主板我A安存在？。

一阴(收敛)一阳(发散)，孤阴不生，孤阳不长。
<一阳穿2线> 当一根大阳线在短时间穿ma20&ma60，即为多周期共振，需要特别关注。
            股价走势即是在<收敛与发散>间轮回。股灾反弹日，早上低开高走即是如此。

不患无位，患所以立。易，一套<逻辑推演框架>，阴阳分解而得当下的位置，并未来可能的位置。

波动，其强大的预测功能并不是重点，而是通过其<知道自已现在所处的位置>，并进行策略规划。
所以，怎么看并不重要，重要的是你怎么防范未来可能出现的风险，怎么通过波动实现操作预期。

# 背离.背驰

[莫大背离](http://blog.sina.com.cn/s/blog_5209b8b10100r2ms.html)

1 背离核心：浪之级别
2 推动浪子浪背离，将触发同级修正浪（如同级3浪(主升浪)5浪背离，触发<大级别修正浪>）
  浪的划分：ma20回抽 or macd回抽0轴
3 背离定义：
  股价不断创新高而指标数值不再创新高就是<顶背离>
  股价不断创新低而指标数值不再创新低就是<底背离>
4 背离意义：
  <背离之意义在于预测转折点>
  通常大级别顶背离要出现三次或以上才是可靠的，尤其在周线级别上则是一个非常长时间的中期调整。
  此时，在击破股价的下趋势线时，是你最后清仓的时机。并开始进入<做空模式>。
  本着买入要慢的原则，通常在判断底背离时，指标分析者多会以<股价突破向下倾斜的上趋势线>为判断转折的原则，那里回压趋势线是买点。
  而波动分析者则不然，当背离发生时，他们会以<下行波段的推动结构末端>出现反向上行推动的原始细级别结构为依据，在那个位置就会先于市场多数人动作。
5 转折点
  RSI(9),L1,L2 L2取邻近高点作趋势线，当RSI突破L2线时表明价格趋势有出现逆转的可能。
  背离：diff(REF(高点RSI(9)),1) diff(REF(低点RSI(9)),1)都同时小于0，即a(up)渐小 且 a(down)渐大
  跌破ma20，并使用子级别
...
介绍一下一般资产管理者的做法，如果管理资产的组合投资份额是单一个股持仓不超过资产总额的20%。

RSI(9),L1,L2 L2取邻近高点作趋势线，当RSI突破L2线时表明价格趋势有出现逆转的可能。
RSI突破L2时，介入量只是20%仓位中的3%在这种位置介入，一旦出现与预期相反的走势时，则止损；
但在当股价二次回压，RSI不再跌破L2线，且出现返身上行时，这时介入的增仓量是20%中的5%；
如果价格趋势得到上行确认，则在RSI突破L1线时，冲击盘在确认趋势逆转时的介入量是20%中的8%。

# 三无级别的新手&厚重的财富是需要厚重的时间积淀 2015-05-31

三无级别的新手：无基础知识、无风险控制能力、无时间看盘。
