...
明白了[边界](圣杯)，你便清楚了当下的[主线形势](5日均线上or下)，[支线形势](ma80.F1)
那什么是边界呢？简单说，边界就是势力的缓冲带，即是双方都舒服的位置。
边界通常用均线来表征，均线也有级别。<有主力合约，也有主力均线>。

1 ma20(F60)作为短线最重要的均线。
  日分时均线(加入成交量的加权数据)，是收官重要信号
  ma80(F4)作为超短重要均线，~=分时均线。
  ma80(F1)作为操作均线
2 日low形成支撑，日high形成压力
3 重要的整数点位，如 2400这样的100点大关。

# 方向.交易盈利的手段

<方向=5日线上or下>，线上则红多绿少，线下则绿多红少。有了方向，打2还1才有意义。
交易，<套利=低买高卖，高卖低买>也
...
杯满则溢，月盈则亏。没有永恒的辉煌。
  ...
  F1.40是重要的时间窗口。
长风破浪会有时，但不是每时。
  小级别只有在同级别的大方向中前进，才能获得最大的效率。ma80(F1)ma300(F1)收敛。[j1701](2016-09-23跟着5日线往上赚钱很容易)
打一还二
...
双底支撑<跌破新低>(参考macd背离、重要点位支撑可加分)
脉冲反转          (参考持仓量)
均线交叉<计算盈亏比=参考重要支撑和压力线>
1阳穿3线
