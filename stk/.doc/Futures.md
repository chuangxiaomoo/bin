...
因为涨跌停按幅度计算，贵者当时变化大，所以

dif=(N-F)
dif'=K×(N-F)'

(N-F)＞0时，涨停，dif'＞0；跌停，dif'＜0
(N-F)＜0时，涨停，dif'＜0；跌停，dif'＞0

date  code    yesc      结    收
1104  rb1701  2716      2726  2889
1104  rb1705  2682      2693  2854
              34        33    35      -- dif

涨跌停幅度=34x6%=34x.06=2，
即上半场拉开距离，最终又要回到2之内，因此：
ma30＞ma480，做空
ma30＜ma480，做多
...
1 m480,与mid(30)的相对位置决定方向<试图多加m7,m120求精确，效果不佳>。
2 由此开始双向操作，而不是原版本的<单向做空波动率>

实现如下：
1 <仓位类型>分两种：1为做多波动率，-1为做空波动率，最后计算收益时使用
2 <开仓时间>决定平仓目标起始值，随时间延长，而向mid靠近
3 stdn~=2.5，波动范围=2.5x4=10，10/ma30=.33u是一根K的波动量，
  .66u相当2K剧烈波动，则5K.stdn=1.65u的波动，以此决定真的反转：平仓目标起始值由top.bot转为mid
4
